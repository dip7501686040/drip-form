...
const SelectField: FC<SelectFieldProps> = ({
  ...
  const [countryCity, setCountryCity] = useState<countryCityType>({
    country: '',
    city: '',
  })
  ...
  const handleCountryCityChange = (name: string, e: any) => {
    setCountryCity((prevState: countryCityType) => {
    ...
    <div>
      <div style={{ marginBottom: '20px' }}>
        ...
        <Select
          ...
          onChange={(e) => handleCountryCityChange('country', e)}
      ...
      <div>
        ...
        <Select
          ...
          onChange={(e) => handleCountryCityChange('city', e)}
          options={cityOption}
          {...restProps}
        />
      </div>
