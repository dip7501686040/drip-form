...
const SelectField: FC<SelectFieldProps> = ({
  ...
  const [countryState, setCountryState] = useState<countryStateType>({
    country: '',
    state: '',
  })
  ...
  const handleCountryStateChange = (name: string, e: any) => {
    setCountryState((prevState: countryStateType) => {
  ...
  return (
    <div>
      <div style={{ marginBottom: '20px' }}>
        <label style={{ marginRight: '27px' }}>Country</label>
        <Select
          style={style}
          {...(multiple
            ? {
          ...
          onChange={(e) => handleCountryStateChange('country', e)}
          options={countryOption}
          {...restProps}
        />
      </div>
      <div>
        <label style={{ marginRight: '40px' }}>State</label>
        <Select
          style={style}
          {...(multiple
            ? {
          ...
          onChange={(e) => handleCountryStateChange('state', e)}
          options={stateOption}
          {...restProps}
        />
      </div>
